...
flags.DEFINE_bool("eval", False, "eval? [True]")
...
flags.DEFINE_integer("val_num_batches", 200, "validation num batches [100]") # 200 은 full validation
...
flags.DEFINE_float("init_lr", 0.0005, "Initial learning rate [0.001]")
...
# For testing
flags.DEFINE_integer("beam_width", 3, "For Beamsearch, beam width")
...
flags.DEFINE_integer("max_to_keep", 5, "Max recent saves to keep [20]")
